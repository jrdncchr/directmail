...
class Backup_model extends CI_Model {
    ...
    public function backup($user_id)
    {
        ...
        if (ENVIRONMENT === 'development') {
            ...
            $command = 'mysqldump -u directmail -ppogiako123! -h localhost directmail property property_comment property_history property_mailing property_replacement download_history download_history_property list list_bullet_point list_category list_paragraph list_testimonial > ' . $path;
        }
        exec($command);
    ...
    public function restore($id)
    {
        ...
        if (ENVIRONMENT === 'development') {
            ...
            $command = 'mysql -u directmail -ppogiako123! -h localhost directmail < ' . $path;
        }
