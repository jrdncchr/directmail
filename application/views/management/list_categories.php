<div id="app">
    ...
    <div class="row">
        <div class="col-sm-12 panel-white">
            <a href="<?php echo base_url() . 'management/list_categories/form'; ?>" class="btn btn-xs btn-default" style="margin-bottom: 20px;"><i class="fa fa-plus-circle"></i> Add a list Category</a>
